...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=<tag:main_charset />" />
    <!-- Bootstrap Core CSS -->
    <link href="style/darklair/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/darklair/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<div id="main">
    ...
    <script src="style/darklair/js/bootstrap.min.js"></script>
<if:IS_DISPLAYED_2>
    <!-- Navigation -->
  ...
  <div id="bodyarea" style="padding:4ex 0 0 0;">  
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td valign="top" width="5" rowspan="2"></td>
        <if:HAS_LEFT_COL>
        <td id="col" valign="top" width="150"><tag:main_left /></td>
        <td valign="top" width="5" rowspan="2"></td>
        </if:HAS_LEFT_COL>
