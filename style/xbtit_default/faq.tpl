<TABLE cellpadding="1" cellspacing="1" width="100%" border="0" align="center">
	<TR><TD class="lista" style="display:block; overflow:auto; marging-right:10px;">

<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><tag:site_name />&nbsp;&nbsp;Frequintly Asked Questions</div>

<ul>
<li><a href="#site"><b>Site information</b></a>
  <div class="faqlink"><ul>
...
<li><a href="#user"><b>User information</b></a>
  <div class="faqlink"><ul>
          ...
          <li><a href="#user4" class="altlink">Can you delete my (confirmed) account?</a>
                <img src="images/updated.png" alt="Updated" width="36" height="7" align="absbottom"></li>
...
<li><a href="#up"><b>Uploading</b></a>
  <div class="faqlink"><ul>
    <li><a href="#up3" class="altlink">Can I upload your torrents to other trackers?</a>
        <img src="images/new.png" alt="New" width="18" height="7" align="absbottom"></li>
  </ul></div>
</li>
<br>
<li><a href="#dl"><b>Downloading</b></a>
  <div class="faqlink"><ul>
    ...
    <li><a href="#dl5" class="altlink">Why do my downloads sometimes stall at 99%?</a></li>
           ...
           <img src="images/new.png" alt="New" width="18" height="7" align="absbottom">
...
<br>
<li><a href="#other"><b>What if I can't find the answer to my problem here?</b></a></li></ul>
</td></tr></table>
<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="site" id="site">&nbsp;&nbsp;Site information&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>

<table width="100%" border="0" cellspacing="5" cellpadding="5"><tr><td class="lista" style="text-align:left;">
<ul>
<br>
<b>What is this bittorrent all about anyway? How do I get the files?</b><a name="site1" id="site1"></a><br>
<br>
Check out <a class=altlink href="redir.php?url=http://www.btfaq.com/"><u>Brian's BitTorrent FAQ and Guide</u></a>.
</ul></td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="user" id="user">&nbsp;&nbsp;User information&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>

<table width="100%" border="0" cellspacing="5" cellpadding="5"><tr><td class="lista" style="text-align:left;">
<ul>
<b>I registered an account but did not receive the confirmation e-mail!</b><a name="user1" id="user1"></a><br>
<br>
Please use <a class=altlink href="index.php?page=recover"><u>this form</u></a> to have the login details mailed back to you.<br>
<br>
<b>Can you delete my (confirmed) account?</b><a name="user4" id="user4"></a><br>
<br>
You can <a class=altlink href="index.php?page=staff"><u>contact</u></a> the sites <b>Owner</b> asking him/her nicely to delete the account so you can re-register.
<br>
<br>
<b>So, what's MY ratio?</b><a name="userb" id="userb"></a><br>
<br>
Your ratio is displayed on the user toolbar. There is one located at the top of the page and one located on the side block.<br>
<br>
...
subject at <a class="altlink" href="redir.php?url=http://portforward.com/" target="_blank"><u>PortForward</u></a>).<br>
<br>
<br>
<b>How do I add an avatar to my profile?</b><a name="userd"></a><br>
<br>
First, find an image that you like, and that is within the
<a class="altlink" href="index.php?page=rules">Rules</a>. Then you will have
to find a place to host it, 
(Some popular choices are <a class="altlink" href="http://photobucket.com/" target="_blank"><u>Photobucket</u></a>,
<a class="altlink" href="http://uploadit.org/" target="_blank"><u>Upload-It!</u></a> or
<a class="altlink" href="http://www.imageshack.us/" target="_blank"><u>ImageShack</u></a>).
All that is left to do is copy the URL you were given when
uploading it to the avatar field in your usercp under change profile.<br>
<br>
Please do not make a post just to test your avatar. If everything is allright you'll see it
in your details page which is in your account.</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="stats">&nbsp;&nbsp;Stats&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>
...
<br>
<b>1.</b> <i>You are the single <tag:site_name /> user in the LAN</i><br>
<br>
You should use the same <tag:site_name /> account in all the computers.<br>
<br>
...
<a class=altlink href="redir.php?url=http://www.microsoft.com/downloads/details.aspx?FamilyID=1dcff3ce-f50f-4a34-ae67-cac31ccd7bc9&amp;displaylang=en" target="_blank"><u>here</u></a>).
...
<br>
<br>
<b>2.</b> <i>There are multiple Tracker users in the LAN</i><br>
<br>
At present there is no way of making this setup always work properly with xBtit Tracker.
...
<br>
<br>
<b>For those of you who are interested...</b><a name="stats9" id="stats9"></a><br></ul>
<br>
<ul>Some <a class="altlink" href="index.php?page=anatomy"><u>info</u></a> about the &quot;Anatomy of a torrent session&quot;.</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="up">&nbsp;&nbsp;Uploading&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>

<table width="100%" border="0" cellspacing="5" cellpadding="5"><tr><td class="lista" style="text-align:left;">

Please Refer to the <tag:site_name /> <a class=altlink href="index.php?page=ulguide"><u>General Uploading Guide</u></a>.
<br>
<br><ul>
<b>Can I upload your torrents to other trackers?</b><a name="up3"></a><br>
<br>
No. We are a closed, limited-membership community. Only registered users can use the <b><tag:site_name /></b>.
Posting our torrents on other trackers is useless, since most people who attempt to download them will
be unable to connect with us. This generates a lot of frustration and bad-will against us at <b><tag:site_name /></b>,
...
torrent, pointing to some other tracker, and upload it to the site of your choice.)</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="dl">&nbsp;&nbsp;Downloading&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>

<table width="100%" border="0" cellspacing="5" cellpadding="5"><tr><td class="lista" style="text-align:left;">
<ul>
<b>How do I use the files I've downloaded?</b><a name="dl1"></a><br>
<br>
Check out <a class="altlink" href="index.php?page=formats"><u>File Formats</u></a>.<br>
<br>
<br>
<b>Downloaded a movie and don't know what CAM/TS/TC/SCR means?</b><a name="dl2"></a><br>
<br>
Check out <a class="altlink" href="index.php?page=videoformats"><u>Video Formats</u></a>.<br>
<br>
<br>
...
<a class="altlink" href="index.php?page=rules"><u>Rules</u></a>.<br>
...
<table class="lista" cellspacing="0" cellpadding="0">
 <tr>
        <td class=header width="70">Ratio below</td>
        <td class=lista width="40" bgcolor="#F5F4EA"><font color="#BB0000"><div align="center">0.75</div></font></td>
        <td class=header width="110">and/or upload below</td>
        <td class=lista width="40" bgcolor="#F5F4EA"><font color="#BB0000"><div align="center">5.0GB</div></td>
        <td class=header width="50">delay of</td>
	      <td class=lista width="40" bgcolor="#F5F4EA"><font color="#BB0000"><div align="center">48h</div></font></td>
 </tr>
 <tr>
        <td class=header>Ratio below</td>
        <td class=lista bgcolor="#F5F4EA"><font color="#A10000"><div align="center">1.00</div></font></td>
        <td class=header>and/or upload below</td>
        <td class=lista bgcolor="#F5F4EA"><font color="#A10000"><div align="center">10GB</div></td>
	<td class=header>delay of</td>
	<td class=lista bgcolor="#F5F4EA"><font color="#A10000"><div align="center">24h</div></font></td>

 </tr>
 <tr>
        <td class=header>Ratio below</td>
        <td class=lista bgcolor="#F5F4EA"><font color="#880000"><div align="center">1.50</div></font></td>
        <td class=header>and/or upload below</td>
        <td class=lista bgcolor="#F5F4EA"><font color="#880000"><div align="center">25GB</div></td>
	<td class=header>delay of</td>
	<td class=lista bgcolor="#F5F4EA"><font color="#880000"><div align="center">12h</div></font></td>

 </tr>
 <tr>
        <td class=header>Ratio below</td>
        <td class=lista bgcolor="#F5F4EA"><font color="#6E0000"><div align="center">2.00</div></font></td>
        <td class=header>and/or upload below</td>
        <td class=lista bgcolor="#F5F4EA"><font color="#6E0000"><div align="center">50GB</div></td>
	<td class=header>delay of</td>
	<td class=lista bgcolor="#F5F4EA"><font color="#6E0000"><div align="center">06h</div></font></td>
...
<br>
<b><tag:site_name /></b> does not allow clients to use ports commonly associated with p2p protocols.
...
<table class="lista" cellspacing="0" cellpadding="0">
  <tr>
        <td class=header width="80">Direct Connect</td>
        <td class=lista width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">411 - 413</div></font></td>
  </tr>
  <tr>
        <td class=header width="80">Kazaa</td>
        <td class=lista width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">1214</div></font></td>
  </tr>
  <tr>
        <td class=header width="80">eDonkey</td>
        <td class=lista width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">4662</div></font></td>
  </tr>
  <tr>
        <td class=header width="80">Gnutella</td>
        <td class=lista width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">6346 - 6347</div></font></td>
  </tr>
  <tr>
        <td class=header width="80">BitTorrent</td>
        <td class=lista width="80" bgcolor="#BBAF9B"><font color="#6E0000"><div align="center">6881 - 6889</div></font></td>
 </tr>
</table>
<br>
...
cf. <a class="altlink" href="http://www.iana.org/assignments/port-numbers" target="_blank"><u>IANA</u></a>). Notice that some clients,
...
<i><a href="#user8" class="altlink"><u>Why am I listed as not connectable?</u></a></i> &nbsp;section
...
Note that this a maximum value, the torrent may be deleted at any time if it's inactive.</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="dlsp">&nbsp;&nbsp;How can I improve my download speed?&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>
...
<br>
See the <i><a href="#user8" class="altlink"><u>Why am I listed as not connectable?</u></a></i> &nbsp;section.<br>
<br>
<br>
...
such as <a class="altlink" href="redir.php?url=http://www.netlimiter.com/" target="_blank"><u>NetLimiter</u></a>.<br>
<br>
Browsing was used just as an example, the same would apply to gaming, IMing, etc...</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="prox" id="prox">&nbsp;&nbsp;My ISP uses a transparent proxy. What should I do?&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>
...
<table class="lista" cellspacing="0" cellpadding="0">
 <tr>
        <td class=header valign="top" bgcolor="#BBAF9B" width="100">&nbsp;<font color="#BB0000">Transparent</font></td>
        <td class=lista valign="top">A transparent proxy is one that needs no configuration on the clients. It works by automatically redirecting all port 80 traffic to the proxy. (Sometimes used as synonymous for non-anonymous.)</td>
 </tr>
 <tr>
        <td class=header valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Explicit/Voluntary</font></td>
        <td class=lista valign="top">Clients must configure their browsers to use them.</td>
 </tr>
 <tr>
        <td class=header valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Anonymous</font></td>
        <td class=lista valign="top">The proxy sends no client identification to the server. (HTTP_X_FORWARDED_FOR header is not sent; the server does not see your IP.)</td>
 </tr>
 <tr>
        <td class=header valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Highly Anonymous</font></td>
        <td class=lista valign="top">The proxy sends no client nor proxy identification to the server. (HTTP_X_FORWARDED_FOR, HTTP_VIA and HTTP_PROXY_CONNECTION headers are not sent; the server doesn't see your IP and doesn't even know you're using a proxy.)</td>
 </tr>
 <tr>
        <td class=header valign="top" bgcolor="#BBAF9B">&nbsp;<font color="#BB0000">Public</font></td>
        <td class=lista valign="top">(Self explanatory)</td>
 </tr>
</table>
<br>
...
<br>
Try <a href="redir.php?url=http://proxyjudge.org" class="altlink" target="_blank"><u>ProxyJudge</u></a>. It lists the HTTP headers that the server where it is running
...
<br>
The xBtit tracker is quite smart at finding your real IP, but it does need the proxy to send the HTTP header
...
like <a href="redir.php?url=http://www.socks.permeo.com"><u>socks</u></a> and that is outside the scope of this FAQ.<br>
<br>
...
thing to try should be connecting to "<b><tag:tracker_url />/announce.php</b>". Note that even if this works your bt client will still try
...
<ul>
    <li>Choose any public <b>non-anonymous</b> proxy that does <b>not</b> use port 80
        (e.g. from <a href="redir.php?url=http://tools.rosinstrument.com/proxy" class="altlink" target="_blank"><u>this</u></a>,
        <a href="redir.php?url=http://www.proxy4free.com/index.html" class="altlink" target="_blank"><u>this</u></a> or
        <a href="redir.php?url=http://www.samair.ru/proxy" class="altlink" target="_blank"><u>this</u></a> list).</li>
    ...
    <li>(Facultative) Visit <a href="redir.php?url=http://proxyjudge.org" class="altlink" target="_blank"><u>ProxyJudge</u></a>. If you see an HTTP_X_FORWARDED_FOR in
        the list followed by your IP then everything should be ok, otherwise choose another proxy and try again.<br></li>

    <li>Visit "<b><tag:tracker_url /></b>/". Hopefully the tracker will now pickup your real IP (check your profile to make sure).</li>
</ul>
<br>
...
<br>
This section was written for "<b><tag:site_name /></b>", a closed, port 80-81 tracker. Other trackers may be open or closed, and many listen
on e.g. ports 6868 or 6969. The above does <b>not</b> necessarily apply to other trackers.</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="conn" id="conn">&nbsp;&nbsp;Why can't I connect? Is the site blocking me?&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>
...
<br>
The site blocks addresses listed in the (former) <a class=altlink href="redir.php?url=http://methlabs.org/" target="_blank"><u>PeerGuardian</u></a>
...
<a href="redir.php?url=http://sourceforge.net/projects/burst/" class="altlink" target="_blank"><u>MakeTorrent</u></a>,
and replacing the announce url to <b>"<tag:tracker_url />/announce.php"</b><br>
<br>
...
<b>"<tag:tracker_url />/announce.php"</b>. (If you're thinking about changing the number before the
announce url instead, you know too much to be reading this.)</ul>
<br>
</td></tr></table>

<tr><td class="lista">
<div class="header" valign="middle" style="padding-left:12px; font-weight:bold; padding-top:2px;" height="22"><font color=4F4F4F><a name="other" id="other">&nbsp;&nbsp;What if I can't find the answer to my problem here?&nbsp;&nbsp;<a href="#">&nbsp;&uarr;&nbsp;</a></font></div>

<table width="100%" border="0" cellspacing="5" cellpadding="5"><tr><td class="lista" style="text-align:left;">

<ul>Post in the <a href="index.php?page=forum"><u>Forums</u></a>, by all means. You'll find they
are usually a friendly and helpful place,
provided you follow a few basic guidelines:</ul>
<ul>
