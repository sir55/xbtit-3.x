...
<form action="<tag:frm_action />" name="config" method="post" onsubmit="return test_smtp_password()">
  <table class="lista" width="100%" align="center">
    ...
    <tr>
      <td class="header"><tag:language.PHP_ERROR /></td>
      <td class="lista"><input type="checkbox" name="phperror" value="phperror" <tag:config.phperror /> /></td>
    </tr>
    <tr>
    ...
    <tr>
      <td class="header" align="center" colspan="4"><tag:language.TORRENT_LIST /></td>
    </tr>
    <tr>
      <td class="header"><tag:language.SETTING_SHOW_COMMENTS /></td>
      <td class="lista"><input type="checkbox" name="comment" value="comment" <tag:config.comment /> /></td>
      <td class="header"><tag:language.SETTING_SHOW_RATING /></td>
      <td class="lista"><input type="checkbox" name="rating" value="rating" <tag:config.rating /> /></td>
    </tr>
    <tr>
