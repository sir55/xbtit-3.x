...
<table class="lista" width="100%" align="center">
  <tr>
    ...
    <td class="header" align="center"><tag:language.FORUM_N_SORT_H /></td>
    <td class="header" align="center"><tag:language.FORUM_N_SORT_S /></td>
...
<form name="editforum" action="<tag:frm_action />" method="post">
  <table class="lista" align="center">
    ...
    <tr>
    <td class="header" align ="center"><tag:language.FORUM_SORT /></td>
