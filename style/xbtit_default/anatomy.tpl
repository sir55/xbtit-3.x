<table class="lista" width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td class="embedded">
<div class="cat3" style="padding-left:20px;text-align:left;">Anatomy of a torrent session </div>
<table width="100%" border="1" cellspacing="0" cellpadding="10"><tr><td class="lista" style="padding-left:20px;text-align:left;padding-right:20px;"> 
<br>
...
<br>
&bull;&nbsp;&nbsp;<b>info_hash</b> is just the hash identifying the torrent in question;<br>
&bull;&nbsp;&nbsp;<b>peer_id</b>, as the name suggests, identifies the client (the s588 part identifies Shad0w's 5.8.8, the rest is random);<br>
&bull;&nbsp;&nbsp;<b>port</b> just tells the tracker which port the client will listen to for incoming connections;<br>
&bull;&nbsp;&nbsp;<b>uploaded</b>=0; (this and the following are the relevant ones, and are self-explanatory)<br>
&bull;&nbsp;&nbsp;<b>downloaded</b>=0;<br>
&bull;&nbsp;&nbsp;<b>left</b>=753690875 (how much left); <br>
&bull;&nbsp;&nbsp;<b>event=started</b> (telling the tracker that the client has just started).<br>
<br>
...
<tr><td class="header" align="center">&bull;&nbsp;<a href="javascript: history.go(-1)"> Go Back </a>&nbsp;&bull;</td></tr></table>
</td></tr></table>