...
<form name="new_users" method="post" action="<tag:frm_action />" >
    <table width="100%" border="0" class="lista">
        ...
        <tr>
            ...
            <td align="left" class="lista"><input type="text" id="email" name="email" maxlength="30" value=""  style="width:90%;" /></td>
        </tr>
        <tr>
            <td align="left" class="header"><tag:language.USER_EMAIL_AGAIN />:</td>
            <td align="left" class="lista">
                <input type="text" name="email1" id="email_again" autocomplete="off" maxlength="30" value="" style="width:90%;" />
