...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=<tag:main_charset />" />
    <!-- Bootstrap Core CSS -->
    <link href="style/thehive/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/thehive/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<div id="main">
    ...
    <script src="style/thehive/js/bootstrap.min.js"></script>
<if:IS_DISPLAYED_2>
    <!-- Navigation -->
