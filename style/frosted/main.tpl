...
<head>
  ...
  <meta http-equiv="content-type" content="text/html; charset=<tag:main_charset />" />
    <!-- Bootstrap Core CSS -->
    <link href="style/frosted/css/bootstrap.css" rel="stylesheet">
    <!-- Theme CSS -->
    <link href="style/frosted/main.css" rel="stylesheet">
    <!-- Custom Fonts -->
...
<body>
    ...
    <script src="style/frosted/js/bootstrap.min.js"></script>
<if:IS_DISPLAYED_2>
    <!-- Navigation -->
