...
class sha1lib
{
     ...
     */
    public function core_sha1($x, $len)
    {
        /* append padding */
     ...
     */
    public function zerofill_rightshift($a, $b)
    {
        $z = hexdec(80000000);
        if ($z & $a) {
            $a >>= 1;
