...
$lang[6]='<br /><center>Please <a target="_new" href="http://www.simplemachines.org/download/">download SMF</a> and upload the contents of the archive to the "smf" folder.<br />If you don&#39;t have a "smf" folder please create one in your tracker root and upload<br />the contents of the archive to it.<br /><br />Once uploaded p'; // p at end is a lowercase p for use with $lang[8]
