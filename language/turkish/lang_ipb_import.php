...
$lang[6]='<br /><center>Please <a target="_new" href="http://www.invisionpower.com/">download IPB</a> and upload the contents of the "upload" folder in the archive to the "ipb" folder.<br />If you don&#39;t have an "ipb" folder please create one in your tracker root and upload<br />the contents of  the "upload" folder to it.<br /><br />Once uploaded p'; // p at end is a lowercase p for use with $lang[8]
