...
$language["ACCOUNT_CONGRATULATIONS"]="Gratulacje, twoje konto jest teraz aktywne!<br>Możesz się <a href=\"index.php?page=login\">zalogować</a> na stronie używając swojej nazwy użytkownika i hasła.";
...
$language["ANNOUNCE_URL"]="Adress announce url trackera:";
...
$language["BCK_USERCP"]="Powrót do Panelu Użytkownika";
$language["BLOCK"]="Blok";
$language["BODY"]="Treść";
$language["BOTTOM"]="dół";
$language["BY"]="przez";
$language["CANT_DELETE_ADMIN"]="Nie można usunąć innego Admina!";
$language["CANT_DELETE_NEWS"]="Nie masz uprawnień do usuwania newsów!";
$language["CANT_DELETE_TORRENT"]="Nie masz uprawnień do usuwania torrentów!...";
$language["CANT_DELETE_USER"]="Nie masz uprawnień do usuwania użytkowników!";
$language["CANT_DO_QUERY"]="Nie można wykonać zapytania SQL - ";
$language["CANT_EDIT_TORR"]="Nie masz uprawnień do edytowania torrentów!";
...
$language["CATCHUP"]="Zaznacz wszystkie jako przeczytane";
...
$language["CURRENT_DETAILS"]="Aktualne szczegóły";
...
$language["DEAD_ONLY"]="Tylko nieaktywne";
...
$language["EMAIL_VERIFY_BLOCK"]="Email z potwierdzeniem wysłany";
...
$language["ERR_AVATAR_EXT"]="Niestety, ale albo plik obrazka nie istnieje albo obrazek ma nieprawidłowy format (dozwolone są tylko formaty gif, jpg, bmp lub png).";
...
$language["ERR_COMMENT_EMPTY"]="Komentarz nie może być pusty!";
...
$language["ERR_EMAIL_NOT_FOUND_2"]="nie został znaleziony w bazie danych.";
...
$language["ERR_GUEST_EXISTS"]="Gość to zastrzeżona nazwa użytkownika. Nie możesz sie zarejestrować jako 'Gość'";
...
$language["ERR_LEVEL"]="Niestety, twoja ranga ";
$language["ERR_LEVEL_CANT_POST"]="Nie masz uprawnień do pisania postów na tym forum.";
...
$language["ERR_NO_SPACE"]="Twoja nazwa uytkownika nie może zawierać spacji, proszę zamienić je na podkreślenie:<br /><br />";
...
$language["ERR_PASS_LENGTH_1"]="Hasło musi skladać się z minimum";
$language["ERR_PASS_LENGTH_2"]="znaków.";
$language["ERR_PASS_TOO_WEAK_1"]="Hasło jest zbyt słabe.<br />Ze względów bezpieczeństwa musi zawierac co najmniej";
$language["ERR_PASS_TOO_WEAK_1A"]="Hasło jest zbyt słabe.<br />Ze względów bezpieczeństwa musi zawierac co najmniej";
$language["ERR_PASS_TOO_WEAK_2"]="małą literę";
$language["ERR_PASS_TOO_WEAK_2A"]="małe litery/małych liter";
$language["ERR_PASS_TOO_WEAK_3"]="dużą literę";
$language["ERR_PASS_TOO_WEAK_3A"]="duże litery/dużych liter";
$language["ERR_PASS_TOO_WEAK_4"]="cyfrę";
$language["ERR_PASS_TOO_WEAK_4A"]="cyfr(y)";
$language["ERR_PASS_TOO_WEAK_5"]="symbol";
$language["ERR_PASS_TOO_WEAK_5A"]="symbole/-i";
$language["ERR_PASS_TOO_WEAK_6"]="Oto mocne hasło, którego mógłbyś użyć";
...
$language["ERR_SEND_EMAIL"]="Nie można wysłać emaila. Proszę skontaktować sie z administratorem w sprawie tego błędu.";
$language["ERR_SERVER_LOAD"]="Obciążenie serwera jest zbyt duże w tym momencie. Odświeżanie, proszę czekać...";
...
$language["ERR_TOPIC_ID_NA"]="ID wątku jest niedostępny";
...
$language["ERR_UPDATE_USER"]="Nie można uaktualnić danych użytkownika. Proszę skontaktować sie z administratorem w sprawie tego błędu.";
$language["ERR_USER_ALREADY_EXISTS"]="Użytkownik o takiej nazwie już istnieje!";
$language["ERR_USER_NOT_FOUND"]="Niestety, użytkownik nie został znaleziony";
$language["ERR_USER_NOT_USER"]="Nie masz uprawnień do przeglądania panelu użytkownika innej osoby!";
$language["ERR_USERNAME_INCORRECT"]="Nieprawidłowa nazwa użytkownika";
$language["ERROR"]="Błąd";
...
$language["FORUM_MIN_READ"]="Minimalna ranga odczytu";
$language["FORUM_SEARCH"]="Wyszukiwarka forum";
$language["FORUM_N_SORT_H"]="Główna kolejnośc sortowania";
$language["FORUM_N_SORT_S"]="Dodatkowa kolejnośc sortowania";
$language["FORUM_SORT"]="Kolejność sortowania";
...
$language["GLOBAL_SERVER_LOAD"]="Globalne obciążenie serwera (Wszystkie strony na tym serwerze)";
$language["GO"]="Idź";
...
$language["INSERT_DATA"]="Wpisz wszystkie wymagane dane do wstawienia torrenta.";
$language["INSERT_NEW_FORUM"]="Dodaj nowe forum";
$language["INVALID_ID"]="Niestety, to jest nieprawidłowy ID!";
...
$language["KEYWORDS"]="Słowa kluczowe";
...
$language["LAST_SANITY"]="Ostatni Sanity Check wykonany ";
...
$language["MNU_STATS"]="Dodatkowe statystyki";
$language["MNU_TORRENT"]="Torrenty";
$language["MNU_UCP_CHANGEPWD"]="Zmień hasło";
$language["MNU_UCP_HOME"]="Strona główna Panelu Użytkownika";
$language["MNU_UCP_IN"]="Twója skrzynka odbiorcza";
$language["MNU_UCP_INFO"]="Edytuj Profil";
$language["MNU_UCP_NEWPM"]="Nowa PM";
$language["MNU_UCP_OUT"]="Twoja skrzynka nadawcza";
$language["MNU_UCP_PM"]="Twój skrzynka";
...
$language["NA"]="Niedostępny";
$language["NAME"]="Nazwa";
$language["NEED_COOKIES"]="Uwaga: Musisz mieć włączoną obsługę cookies, aby się zalogować.";
...
$language["NO_RECORDS"]="Niestety, lista jest pusta...";
$language["NO_TOPIC"]="Nie znaleziono wątków";
$language["NO_TORR_UP_USER"]="Ten użytkownik nie wstawił żadnych torrentów";
$language["NO_TORRENTS"]="Brak torrentów...";
$language["NO_USERS_FOUND"]="nie znaleziono użytkowników!";
$language["NOBODY_ONLINE"]="Brak użytkowników online";
$language["NONE"]="Nic";
...
$language["NOT_AUTH_DOWNLOAD"]="Nie masz uprawnień do pobierania.";
$language["NOT_AUTH_VIEW_NEWS"]="Nie masz uprawnień do przeglądania newsów!";
$language["NOT_AUTHORIZED"]="Nie masz uprawnień do przeglądania";
$language["NOT_AUTHORIZED_UPLOAD"]="Nie masz uprawnień do wysyłania!";
$language["NOT_AVAILABLE"]="Niedostępny";
$language["NOT_MAIL_IN_URL"]="To nie jest adres email, który był w linku";
...
$language["PEERS_DETAILS"]="Kliknij tutaj, aby zobaczyć szczegóły peerów";
...
$language["REACHED_MAX_USERS"]="Osiągnięto maksymalną liczbę użytkowników";
$language["READED"]="Przeczytane";
$language["RECEIVER"]="Odbiorca";
$language["RECOVER_DESC"]="Użyj poniższego formularza, aby zresetować swoje haslo, a w ciągu kilku minut otrzymasz email z danymi konta.<br>(Będziesz musiał/-a odpowiedzieć na email potwierdzający.)";
$language["RECOVER_PWD"]="Odzyskaj hasło";
$language["RECOVER_TITLE"]="Odzyskaj straconą nazwę użytkownika lub hasło";
$language["REDIRECT"]="jeżeli twoja przeglądarka nie ma włączonej obsługi javascript, kliknij";
$language["REDIRECT2"]="Jeżeli twoja przeglądarka nie ma włączonej obsługi javascript, kliknij <a href=\"%s\">tutaj</a>.";
...
$language["RESULT"]="Wynik";
$language["RETRY"]="Spróbuj ponownie";
...
$language["REVERIFY_FAILURE"]="<center><br /><strong><font color=\"red\"><u>Niestety, ale ten url jest nieprawidłowy.</u></strong></font><br /><br />Za każdym razem, gdy chcesz zmienić adres email, zostaje wygenerowany losowy numer, więc<br />jeżeli widzisz tę wiadomość, najprawdopodobniej próbowałeś zmienić swój adres email <br />więcej niż raz i używasz starego url.<br /><br /><strong>Prosimy poczekać, aż będziesz absolutnie pewny, że nie otrzymałeś nowego<br />emaila weryfikacyjnego przed ponowną próbą zmiany adresu email.</strong><br /><br />";
$language["REVERIFY_MSG"]="Jeżeli spróbujesz zmienić stary adres email, otrzymasz link potwierdzający na nowy adres email, na który chcesz zmienić stary email.<br /><br /><font color=\"red\"><strong>Adres email nie zostanie uaktualniony dopóki nie potwierdzisz nowego adresu email klikając na link.</strong></font>";
...
$language["SHORT_C"]="C"; //Skrót dla Zakończone
$language["SHORT_L"]="L"; //Skrót dla Leechers
$language["SHORT_S"]="S"; //Skrót dla Seeders
$language["SHOUTBOX"]="ShoutBox";
$language["SIZE"]="Rozmiar";
$language["SORRY"]="Niestety";
$language["SORTID"]="ID sortowania";
$language["SPEED"]="Prędkość";
$language["STICKY"]="Przyklejony";
$language["SUB_CATEGORY"]="Podkategoria";
$language["SUBJECT"]="Temat";
$language["SUBJECT_MAX_CHAR"]="Temat maksymalnie może mieć";
...
$language["TRACKER_INFO"]="$users użytkownikow, $torrents torrentów ($seeds seedów i $leechers leecherów, $percent%)";
...
$language["UPFAILED"]="Wysyłanie zakończone niepowodzeniem";
$language["UPLOAD_IMAGE"]="Prześlij obrazek";
$language["UPLOAD_LANGUAGE_FILE"]="Wyślij plik językowy";
$language["UPLOADED"]="Wysłane";
$language["UPLOADER"]="Wysyłający";
$language["UPLOADS"]="Wysłane pliki";
$language["URL"]="URL";
$language["USER"]="Użytkownik";
$language["USER_CP"]="Mój Panel";
$language["USER_CP_1"]="Panel Użytkownika";
$language["USER_DETAILS"]="Profil użytkownika";
$language["USER_EMAIL"]="Ważny email";
$language["USER_ID"]="ID użytkownika";
$language["USER_JOINED"]="Dołączył";
$language["USER_LASTACCESS"]="Ostatnio widziany";
$language["USER_LEVEL"]="Ranga";
$language["USER_LOCAL_TIME"]="Lokalny czas użytkownika";
$language["USER_NAME"]="Użytkownik";
$language["USER_PASS_RECOVER"]="Odzyskiwanie hasła/nazwy użytkownika";
$language["USER_PWD"]="Hasło";
$language["USERS_SEARCH"]="Wyszukiwanie użytkowników";
$language["VIEW_DETAILS"]="Przeglądaj szczegóły";
$language["VIEW_TOPIC"]="Przeglądaj wątek";
$language["VIEW_UNREAD"]="Zobacz nieprzeczytane";
$language["VIEWS"]="Odsłon";
...
$language["WELCOME_UCP"]="Witamy w Panelu Użytkownika";
$language["WORD_AND"]="i";
...
$language["EXTRA"]="dodatkowe";
$language["DROPDOWN"]="rozwijana lista";
$language["TORRENT_MENU"]="Menu torrent";
$language["USER_MENU"]="Menu użytkownika";
$language["ADMIN_ACCESS"]="Dostęp Admina";
$language["STAFF_ACCESS"]="Załoga";
$language["UPLOAD_LINK"]="Wysyłanie torrenta";
# End

$language["USERNAME"]="Nazwa użytkownika";
$language["SUBMIT"]="Zapisz zmiany";

$language["QUAR_PM_SUBJ"]="Podejrzenie próby włamania";
$language["QUAR_PM_MSG_1"]="próbował przesłać plik zawierający kod php. Plik przeniesiono do kwarantanny";
$language["QUAR_PM_MSG_2"]="Możliwe jednak, że jest to fałszywy alarm, więc sprawdź plik za pomocą edytora hex zanim zbanujesz tego użytkownika.\n\nPróbę ataku podjęto z/przez";
$language["QUAR_OUTPUT"]="Twoja próba przesłania pliku z kodem php została udaremniona i został o niej powiadomiony właściciel trackera!";
$language["QUAR_ERR"]="Błąd kwarantanny";
$language["QUAR_DIR_PROBLEM_1"]="Folder kwarantanny";
$language["QUAR_DIR_PROBLEM_2"]="nie istnieje, podaj prawidłową lokalizację folderu kwarantanny w [b]Panel Admina-->Ustawienia Pakietu Bezpieczeństwa[/b]";
$language["QUAR_DIR_PROBLEM_3"]="nie jest zapisywalny, zmień jego atrybuty CHMOD na 0777";
$language["QUAR_UNABLE"]="Z powodu nieznanego błędu pliku nie można poddac kwarantannie. Sprawdź skrzynkę odbiorczą, aby zapoznać się ze sczegółami";
$language["QUAR_NOT_SET"]="Nie ustawiono folderu";

$language["QUAR_TMP_FILE_MISS"]="Nie można odnaleźć pliku temp!";
$language["SECSUI_ACC_PWD_1"]="Twoje hasło powinno:";
$language["SECSUI_ACC_PWD_1A"]="Twoje hasło powinno:";
$language["SECSUI_ACC_PWD_2"]="mieć przymajmniej";
$language["SECSUI_ACC_PWD_3"]="znak";
$language["SECSUI_ACC_PWD_3A"]="znaki/-ów";
$language["SECSUI_ACC_PWD_4"]="zawierać przynajmniej";
$language["SECSUI_ACC_PWD_5"]="małą literę";
$language["SECSUI_ACC_PWD_5A"]="małe litery/małych liter";
$language["SECSUI_ACC_PWD_6"]="dużą literę";
$language["SECSUI_ACC_PWD_6A"]="duże litery/dużych liter";
$language["SECSUI_ACC_PWD_7"]="cyfrę";
$language["SECSUI_ACC_PWD_7A"]="cyfr(y)";
$language["SECSUI_ACC_PWD_8"]="symbol";
$language["SECSUI_ACC_PWD_8A"]="symbole/-i";

$language["LOGS_PHP"]="Log błędów PHP";
$language["LOGS_LINE_AMT"]="<b>Liczba linii:</b>";
$language["LOGS_LINE_AMT_1"]="<b>Liczba linii do wyświetlenia</b>";
$language["LOGS_COOLY_NAME"]="<b>Nazwa logów:</b>&nbsp;Nazwa plików logów. Pomyśl o czymś autentycznym.";
$language["LOGS_COOLY_NAMES"]="Nazwa plików będzie ta sama oprócz dołączonej daty utworzenia pliku.";
$language["LOGS_COOLY_PATH"]="<b>Katalog do zapisu logów:</b> Najlepiej, aby katalog znajdował się powyżej katalogu głównego trackera (jeśli to możliwe), bez końcowego ukośnika<br /> i musi być zapisywalny. W przeciwnym razie, zachowaj obecną sugerowaną ścieżkę.";
$language["LOGS_COOLY_PATHS"]="Zalecana ścieżka:";
