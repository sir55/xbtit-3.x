...
$language["ERR_INV_EMAIL"]="Musisz wpisać ważny adres email";
...
$language["RECOVER_EMAIL_2"]="Zgodnie z twoją prośbą wygenerowane zostało dla Ciebie nowe hasło do twojego konta.\n\nPoniżej znajdują się nowe dane potrzebne do zalogowania się na konto:\n\n    Nazwa użytkownika: %s\n    Hasło: %s\n\nMożesz się teraz zalogować %s\n\n--\n%s";
?>