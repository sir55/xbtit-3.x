...
CREATE TABLE `{$db_prefix}files` (
  ...
  `data` datetime NOT NULL default '1000-01-01 00:00:00',
  ...
  `lastupdate` datetime NOT NULL default '1000-01-01 00:00:00',
  `anonymous` enum('true','false') NOT NULL default 'false',
  `lastsuccess` datetime NOT NULL default '1000-01-01 00:00:00',
...
CREATE TABLE `{$db_prefix}users` (
  ...
  `joined` datetime NOT NULL default '1000-01-01 00:00:00',
  `lastconnect` datetime NOT NULL default '1000-01-01 00:00:00',
